                    ...
                    <div className="space-y-6">
                        <div className="bg-[var(--bg-card-strong)] border border-[var(--bg-tertiary)] p-6 rounded-2xl">
                            ...
                            <div className="space-y-4">
                                <a href="mailto:conaugh@oasisai.work" className="flex items-center gap-4 p-4 rounded-xl bg-[var(--bg-tertiary)] hover:bg-[var(--bg-secondary)] transition border border-[var(--border)] group">
