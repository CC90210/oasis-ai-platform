...
interface ClientData {
    ...
    monthlyPerformance: WeeklyPerformance[];
}
...
const ClientDashboard: React.FC = () => {
    ...
    if (!clientData) return null; // Should not happen given loading/error states
...
const StatCard = ({ label, value, sublabel, icon }: { label: string, value: string | number, sublabel?: string, icon: React.ReactNode }) => (
